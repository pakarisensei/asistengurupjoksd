document.addEventListener('DOMContentLoaded', () => {
    // --- DATABASE (Semua konstanta database Anda diletakkan di sini) ---
    ...
    /**
     * @important
     * Fungsi ini sekarang memanggil Netlify Function Anda, bukan Google API secara langsung.
     * Ini membuat API key Anda aman di sisi server.
     */
    async function callGemini(prompt) {
        try {
            ...
            return `Terjadi kesalahan saat menghubungi asisten AI: ${error.message}. Coba periksa koneksi atau hubungi administrator.`;
        }
    }
    ...
    function getFormContext() {
        return {
            fase: domElements.faseSelect.value,
            kelas: domElements.kelasSelect.value,
            materiJudul: domElements.materiPembelajaranSelect.options[domElements.materiPembelajaranSelect.selectedIndex].text,
    ...
    function setupEventListeners() {
        ...
        geminiMateriBtn.addEventListener('click', async () => {
            const { fase, kelas, materiJudul, materiSpesifik } = getFormContext();
            showModal("Materi Ajar Tambahan", '<p class="text-center">Menyusun naskah materi ajar dengan Asisten... ??</p>');
        ...
        generateBtn.addEventListener('click', () => {
            ...
            domElements.outputContainer.innerHTML = '<p class="text-center">Menyusun Modul Ajar, mohon tunggu... ??</p>';
    ...
    // Sisa fungsi helper seperti populateKelas, populateMateri, generateModuleContent, dll.
    // ... (salin semua fungsi lainnya dari kode asli Anda ke sini) ...
    ...
    function generateModuleContent() {
        ...
        const lkpdSpesifik = lkpdDatabase['default'];
        const saranaSpesifik = saranaDatabase['default'];
